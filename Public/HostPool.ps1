...
Function Update-NmeHostPoolRdpConfig {
	<#
	...
	This function calls the /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/rdp endpoint of the NME REST API, using the patch method.
	...
	.PARAMETER NmePatchHostPoolRdpRequestRest

	Requires an NmePatchHostPoolRdpRequestRest object, as generated by the New-NmePatchHostPoolRdpRequestRest command.
	...
	Param(
		...
		[Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true)][string]$ResourceGroup,
		[Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true)][string]$HostPoolName,
		[Parameter(Mandatory=$true, ValueFromPipelineByPropertyName=$True)][ValidateScript({if ($_.PSObject.TypeNames -contains "NmePatchHostPoolRdpRequestRest"){$true} else{throw " is not a NmePatchHostPoolRdpRequestRest object."}})]$NmePatchHostPoolRdpRequestRest
	)
	Set-NmeAuthHeaders
	Try {
		$json = $NmePatchHostPoolRdpRequestRest | ConvertTo-Json -Depth 20
		Write-Debug 'json:'
		Write-Debug $json
		$Result = Invoke-RestMethod "$script:NmeUri/api/v1/arm/hostpool/$SubscriptionId/$ResourceGroup/$HostPoolName/rdp$QueryString" -Method patch -Headers $script:AuthHeaders -ContentType 'application/json' -body $json
		Write-Verbose ($result | out-string)
		$Result.PSObject.TypeNames.Insert(0, 'NmeArmHostPoolRdpModelRest')
		$Result | Add-Member -NotePropertyName 'subscriptionId' -NotePropertyValue $subscriptionId -erroraction 'SilentlyContinue'
		$Result | Add-Member -NotePropertyName 'resourceGroup' -NotePropertyValue $resourceGroup -erroraction 'SilentlyContinue'
...
Function Set-NmeHostPoolScheduleIdReImageV2 {
	<#
	...
	This function calls the /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/schedule-v2/{scheduleId}/reimage endpoint of the NME REST API, using the put method.
	...
	Try {
		...
		Write-Debug 'json:'
		Write-Debug $json
		$Result = Invoke-RestMethod "$script:NmeUri/api/v1/arm/hostpool/$SubscriptionId/$ResourceGroup/$HostPoolName/schedule-v2/$ScheduleId/reimage$QueryString" -Method put -Headers $script:AuthHeaders -ContentType 'application/json' -body $json
		Write-Verbose ($result | out-string)
...
Function Get-NmeHostPoolScheduleReimageJobV2 {
	<#
	...
	This function calls the /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/schedule-v2/{scheduleId}/reimage/job-params endpoint of the NME REST API, using the get method.
	...
	Set-NmeAuthHeaders
	Try {
		$Result = Invoke-RestMethod "$script:NmeUri/api/v1/arm/hostpool/$SubscriptionId/$ResourceGroup/$HostPoolName/schedule-v2/$ScheduleId/reimage/job-params$Querystring" -Method get -Headers $script:AuthHeaders -ContentType 'application/json'
		$Result.PSObject.TypeNames.Insert(0, 'NmeReimageScheduledBulkJobParams')
		$Result | Add-Member -NotePropertyName 'subscriptionId' -NotePropertyValue $subscriptionId -erroraction 'SilentlyContinue'
		$Result | Add-Member -NotePropertyName 'resourceGroup' -NotePropertyValue $resourceGroup -erroraction 'SilentlyContinue'
		$Result | Add-Member -NotePropertyName 'hostPoolName' -NotePropertyValue $hostPoolName -erroraction 'SilentlyContinue'
...
Function Set-NmeHostPoolScriptedActionScheduleIdV2 {
	<#
	...
	This function calls the /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/schedule-v2/{scheduleId}/script-execution endpoint of the NME REST API, using the put method.
	...
	Try {
		...
		Write-Debug 'json:'
		Write-Debug $json
		$Result = Invoke-RestMethod "$script:NmeUri/api/v1/arm/hostpool/$SubscriptionId/$ResourceGroup/$HostPoolName/schedule-v2/$ScheduleId/script-execution$QueryString" -Method put -Headers $script:AuthHeaders -ContentType 'application/json' -body $json
		Write-Verbose ($result | out-string)
...
Function Get-NmeHostPoolScheduledScriptConfigV2 {
	<#
	...
	This function calls the /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/schedule-v2/{scheduleId}/script-execution/job-params endpoint of the NME REST API, using the get method.
	...
	Set-NmeAuthHeaders
	Try {
		$Result = Invoke-RestMethod "$script:NmeUri/api/v1/arm/hostpool/$SubscriptionId/$ResourceGroup/$HostPoolName/schedule-v2/$ScheduleId/script-execution/job-params$Querystring" -Method get -Headers $script:AuthHeaders -ContentType 'application/json'
		$Result.PSObject.TypeNames.Insert(0, 'NmeRunScriptScheduledBulkJobParams')
		$Result | Add-Member -NotePropertyName 'subscriptionId' -NotePropertyValue $subscriptionId -erroraction 'SilentlyContinue'
		$Result | Add-Member -NotePropertyName 'resourceGroup' -NotePropertyValue $resourceGroup -erroraction 'SilentlyContinue'
		$Result | Add-Member -NotePropertyName 'hostPoolName' -NotePropertyValue $hostPoolName -erroraction 'SilentlyContinue'
...
Function New-NmeHostPoolScheduleReImageV2 {
	<#
	...
	This function calls the /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/schedule-v2/reimage endpoint of the NME REST API, using the post method.
	...
	Try {
		...
		Write-Debug 'json:'
		Write-Debug $json
		$Result = Invoke-RestMethod "$script:NmeUri/api/v1/arm/hostpool/$SubscriptionId/$ResourceGroup/$HostPoolName/schedule-v2/reimage$QueryString" -Method post -Headers $script:AuthHeaders -ContentType 'application/json' -body $json
		Write-Verbose ($result | out-string)
		$Result.PSObject.TypeNames.Insert(0, 'NmeReimageScheduledBulkJobParams')
		$Result | Add-Member -NotePropertyName 'subscriptionId' -NotePropertyValue $subscriptionId -erroraction 'SilentlyContinue'
		$Result | Add-Member -NotePropertyName 'resourceGroup' -NotePropertyValue $resourceGroup -erroraction 'SilentlyContinue'
...
Function New-NmeHostPoolScriptedActionScheduleV2 {
	<#
	...
	This function calls the /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/schedule-v2/script-execution endpoint of the NME REST API, using the post method.
	...
	Try {
		...
		Write-Debug 'json:'
		Write-Debug $json
		$Result = Invoke-RestMethod "$script:NmeUri/api/v1/arm/hostpool/$SubscriptionId/$ResourceGroup/$HostPoolName/schedule-v2/script-execution$QueryString" -Method post -Headers $script:AuthHeaders -ContentType 'application/json' -body $json
		Write-Verbose ($result | out-string)
		$Result.PSObject.TypeNames.Insert(0, 'NmeRunScriptScheduledBulkJobParams')
		$Result | Add-Member -NotePropertyName 'subscriptionId' -NotePropertyValue $subscriptionId -erroraction 'SilentlyContinue'
		$Result | Add-Member -NotePropertyName 'resourceGroup' -NotePropertyValue $resourceGroup -erroraction 'SilentlyContinue'
...
Function Get-NmeHostPoolSelfServiceConfig {
	...
	Try {
		...
		$Result.PSObject.TypeNames.Insert(0, 'NmeHostPoolUserSelfServicePatchModelRest')
...
Function Set-NmeHostPoolSelfServiceConfig {
	...
	.PARAMETER NmeHostPoolUserSelfServicePatchModelRest

	Requires an NmeHostPoolUserSelfServicePatchModelRest object, as generated by the New-NmeHostPoolUserSelfServicePatchModelRest command.
	...
	Param(
		...
		[Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true)][string]$ResourceGroup,
		[Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true)][string]$HostPoolName,
		[Parameter(Mandatory=$true, ValueFromPipelineByPropertyName=$True)][ValidateScript({if ($_.PSObject.TypeNames -contains "NmeHostPoolUserSelfServicePatchModelRest"){$true} else{throw " is not a NmeHostPoolUserSelfServicePatchModelRest object."}})][Alias("NmeHostPoolUserSelfServiceModelRest")]$NmeHostPoolUserSelfServicePatchModelRest
	)
	Set-NmeAuthHeaders
	Try {
		$json = $NmeHostPoolUserSelfServicePatchModelRest | ConvertTo-Json -Depth 20
		Write-Debug 'json:'
		Write-Debug $json
...
Function Get-NmeVmDeploymentConfig {
	...
	Try {
		...
		$Result.PSObject.TypeNames.Insert(0, 'NmeHostPoolVmDeploymentRestPatchRequest')
...
Function Update-NmeVmDeploymentConfig {
	...
	.PARAMETER NmeHostPoolVmDeploymentRestPatchRequest

	Requires an NmeHostPoolVmDeploymentRestPatchRequest object, as generated by the New-NmeHostPoolVmDeploymentRestPatchRequest command.
	...
	Param(
		...
		[Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true)][string]$ResourceGroup,
		[Parameter(Mandatory=$true,ValueFromPipelineByPropertyName=$true)][string]$HostPoolName,
		[Parameter(Mandatory=$true, ValueFromPipelineByPropertyName=$True)][ValidateScript({if ($_.PSObject.TypeNames -contains "NmeHostPoolVmDeploymentRestPatchRequest"){$true} else{throw " is not a NmeHostPoolVmDeploymentRestPatchRequest object."}})][Alias("NmeHostPoolVmDeploymentRestModel")]$NmeHostPoolVmDeploymentRestPatchRequest
	)
	Set-NmeAuthHeaders
	Try {
		$json = $NmeHostPoolVmDeploymentRestPatchRequest | ConvertTo-Json -Depth 20
		Write-Debug 'json:'
		Write-Debug $json
