# Set-NmeHostPoolReimageSchedule

**Endpoint:** `PUT /api/v1/arm/hostpool/{subscriptionId}/{resourceGroup}/{hostPoolName}/schedule-v2/{scheduleId}/reimage`

## Description

Update scheduled re-image ARM host pool session hosts' VMs
...
Set-NmeHostPoolReimageSchedule `
    ...
    -ScheduleStartDate "04/16/2026 00:00:00" `
    -ScheduleStartHour 8 `
