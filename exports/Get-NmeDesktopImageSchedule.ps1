...
#>
function Get-NmeDesktopImageSchedule {
[OutputType([NmePowershell.Models.IDesktopImageSchedule])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeDesktopImageSchedule_Get';
        }
