...
<#
.Synopsis
Get list of App Attach storage locations
.Description
Get list of App Attach storage locations

#>
function Get-NmeAppAttachStorageLocation {
[OutputType([NmePowershell.Models.ILinkedStorageLocation])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeAppAttachStorageLocation_Get';
        }
