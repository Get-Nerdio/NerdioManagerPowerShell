...
#>
function New-NmeDesktopImageRunScriptSchedule {
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeDesktopImageRunScriptSchedule_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeDesktopImageRunScriptSchedule_NewExpanded';
        }
