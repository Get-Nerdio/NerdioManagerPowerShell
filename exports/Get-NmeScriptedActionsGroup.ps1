...
[OutputType([NmePowershell.Models.IScriptedActionsGroup])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeScriptedActionsGroup_Get';
            Get1 = 'NerdioManagerPowerShell.private\Get-NmeScriptedActionsGroup_Get1';
        }
