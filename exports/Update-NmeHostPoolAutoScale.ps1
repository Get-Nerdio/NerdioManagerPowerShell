...
#>
function Update-NmeHostPoolAutoScale {
...
param(
    ...
    [NmePowershell.Models.IAutoScaleUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeHostPoolAutoScale_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeHostPoolAutoScale_UpdateExpanded';
        }
