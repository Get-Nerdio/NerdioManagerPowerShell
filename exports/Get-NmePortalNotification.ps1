...
[OutputType([NmePowershell.Models.IPortalNotification])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmePortalNotification_Get';
            Get1 = 'NerdioManagerPowerShell.private\Get-NmePortalNotification_Get1';
        }
