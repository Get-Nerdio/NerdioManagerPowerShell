...
#>
function Get-NmeRunbookScriptedActionsSchedule {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeRunbookScriptedActionsSchedule_Get';
            Get1 = 'NerdioManagerPowerShell.private\Get-NmeRunbookScriptedActionsSchedule_Get1';
        }
