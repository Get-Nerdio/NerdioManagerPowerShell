...
param(
    ...
    [NmePowershell.Models.ISecureVariableUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeSecureVariable_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeSecureVariable_UpdateExpanded';
        }
