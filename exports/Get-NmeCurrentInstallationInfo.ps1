...
#>
function Get-NmeCurrentInstallationInfo {
[OutputType([NmePowershell.Models.IDeploymentInfo])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeCurrentInstallationInfo_Get';
        }
