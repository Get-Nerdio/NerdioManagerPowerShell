...
param(
    ...
    [NmePowershell.Models.IScriptedActionDelete]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Remove = 'NerdioManagerPowerShell.private\Remove-NmeScriptedAction_Remove';
            RemoveExpanded = 'NerdioManagerPowerShell.private\Remove-NmeScriptedAction_RemoveExpanded';
        }
