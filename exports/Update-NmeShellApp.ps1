...
param(
    ...
    [NmePowershell.Models.IShellAppUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeShellApp_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeShellApp_UpdateExpanded';
        }
