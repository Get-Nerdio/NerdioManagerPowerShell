...
#>
function Invoke-NmeSessionHostDeactivate {
[OutputType([NmePowershell.Models.IResponseWithJobAndArmSessionHost])]
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeSessionHostDeactivate_Invoke';
        }
