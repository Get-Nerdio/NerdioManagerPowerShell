...
#>
function Invoke-NmeHostPoolUnassignUser {
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeHostPoolUnassignUser_Invoke';
            InvokeExpanded = 'NerdioManagerPowerShell.private\Invoke-NmeHostPoolUnassignUser_InvokeExpanded';
        }
