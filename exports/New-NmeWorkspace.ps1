...
[OutputType([NmePowershell.Models.IResponseWithJobAndArmWorkspace])]
...
param(
    ...
    [NmePowershell.Models.IWorkspaceCreate]
    # .
    ${Body},
    ...
    [Parameter(ParameterSetName='NewExpanded')]
    [NmePowershell.Category('Body')]
    [NmePowershell.Runtime.Info(PossibleTypes=([NmePowershell.Models.IWorkspaceCreateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeWorkspace_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeWorkspace_NewExpanded';
        }
