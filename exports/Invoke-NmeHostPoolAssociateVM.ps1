...
#>
function Invoke-NmeHostPoolAssociateVM {
...
param(
    ...
    [NmePowershell.Models.IVmsAssociate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeHostPoolAssociateVM_Invoke';
            InvokeExpanded = 'NerdioManagerPowerShell.private\Invoke-NmeHostPoolAssociateVM_InvokeExpanded';
        }
