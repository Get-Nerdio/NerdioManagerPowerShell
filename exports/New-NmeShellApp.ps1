...
#>
function New-NmeShellApp {
[OutputType([NmePowershell.Models.IResponseWithJobAndShellApp])]
...
param(
    ...
    [NmePowershell.Models.IShellAppCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeShellApp_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeShellApp_NewExpanded';
        }
