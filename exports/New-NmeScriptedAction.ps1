...
param(
    ...
    [NmePowershell.Models.IScriptedActionCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeScriptedAction_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeScriptedAction_NewExpanded';
        }
