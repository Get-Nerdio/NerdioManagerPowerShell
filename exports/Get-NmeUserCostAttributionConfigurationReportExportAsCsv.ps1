...
#>
function Get-NmeUserCostAttributionConfigurationReportExportAsCsv {
...
param(
    ...
    [Parameter()]
    [NmePowershell.PSArgumentCompleterAttribute("UserCostDetail", "ResourceCostDetail", "ResourceCostSummary")]
    ...
    [NmePowershell.Category('Query')]
    [System.String]
    # Applicable only for UserCostDetail and ResourceCostDetail export types.
    # Ignored for ResourceCostSummary
    ${ReportType},
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeUserCostAttributionConfigurationReportExportAsCsv_Get';
        }
