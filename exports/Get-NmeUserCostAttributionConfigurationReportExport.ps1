...
#>
function Get-NmeUserCostAttributionConfigurationReportExport {
[OutputType([NmePowershell.Models.IUserCostAttributionExportReportResponse])]
[CmdletBinding(DefaultParameterSetName='Get', PositionalBinding=$false)]
param(
    [Parameter(Mandatory)]
    [NmePowershell.Category('Path')]
    [System.String]
    # Export ID returned from POST configuration/{id}/report/{year}/{month}/export
    ${ExportId},
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeUserCostAttributionConfigurationReportExport_Get';
        }
