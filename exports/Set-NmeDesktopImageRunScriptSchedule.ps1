...
<#
.Synopsis
Set scheduled script execution on desktop image VM
.Description
Set scheduled script execution on desktop image VM

#>
function Set-NmeDesktopImageRunScriptSchedule {
...
param(
    ...
    [NmePowershell.Models.ICustomScriptScheduleCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeDesktopImageRunScriptSchedule_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeDesktopImageRunScriptSchedule_SetExpanded';
        }
