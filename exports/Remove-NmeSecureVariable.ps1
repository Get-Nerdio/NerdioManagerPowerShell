...
param(
    ...
    [NmePowershell.Models.ISecureVariableDelete]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Remove = 'NerdioManagerPowerShell.private\Remove-NmeSecureVariable_Remove';
            RemoveExpanded = 'NerdioManagerPowerShell.private\Remove-NmeSecureVariable_RemoveExpanded';
        }
