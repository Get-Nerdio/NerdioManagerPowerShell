...
#>
function Get-NmeSessionHostsByWorkspace {
[OutputType([NmePowershell.Models.IArmSessionHost])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeSessionHostsByWorkspace_Get';
        }
