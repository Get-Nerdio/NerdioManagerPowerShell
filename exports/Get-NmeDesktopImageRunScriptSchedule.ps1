...
#>
function Get-NmeDesktopImageRunScriptSchedule {
[OutputType([NmePowershell.Models.ICustomScriptSchedule])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeDesktopImageRunScriptSchedule_Get';
        }
