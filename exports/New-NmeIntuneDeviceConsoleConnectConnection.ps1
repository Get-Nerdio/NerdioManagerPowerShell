...
#>
function New-NmeIntuneDeviceConsoleConnectConnection {
[OutputType([NmePowershell.Models.IResponseWithJobAndConsoleConnectConnectionResponse])]
...
param(
    ...
    [NmePowershell.Models.IConsoleConnectConnection]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeIntuneDeviceConsoleConnectConnection_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeIntuneDeviceConsoleConnectConnection_NewExpanded';
        }
