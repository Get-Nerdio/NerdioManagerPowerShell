...
[OutputType([NmePowershell.Models.IResponseWithJobAndUserCostAttributionConfiguration])]
...
param(
    ...
    [NmePowershell.Models.IUserCostAttributionConfigurationCreate]
    # .
    ${Body},
    ...
    [Parameter(ParameterSetName='NewExpanded', Mandatory)]
    [NmePowershell.Category('Body')]
    [NmePowershell.Runtime.Info(Required, PossibleTypes=([NmePowershell.Models.IUserCostAttributionConfigurationCreateTags]))]
    [System.Collections.Hashtable]
    # Dictionary of <components·1kunypv·schemas·usercostattributionconfigurationcreate·properties·tags·additionalproperties>
    ${Tags},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeUserCostAttributionConfiguration_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeUserCostAttributionConfiguration_NewExpanded';
        }
