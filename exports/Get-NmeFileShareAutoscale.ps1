...
#>
function Get-NmeFileShareAutoscale {
[OutputType([NmePowershell.Models.IAzureFilesAutoscaleConfig])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeFileShareAutoscale_Get';
        }
