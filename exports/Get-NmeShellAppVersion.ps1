...
<#
.Synopsis
Get Shell App versions
.Description
Get Shell App versions

#>
function Get-NmeShellAppVersion {
[OutputType([NmePowershell.Models.IResponseListAndShellAppVersion])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeShellAppVersion_Get';
        }
