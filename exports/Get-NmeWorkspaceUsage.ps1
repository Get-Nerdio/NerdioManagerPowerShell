...
[OutputType([NmePowershell.Models.IUsage])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeWorkspaceUsage_Get';
            Get1 = 'NerdioManagerPowerShell.private\Get-NmeWorkspaceUsage_Get1';
        }
