...
#>
function Update-NmeHostPoolBackupProperty {
[OutputType([NmePowershell.Models.IHostPoolBackup])]
...
param(
    ...
    [NmePowershell.Models.IHostPoolBackup]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeHostPoolBackupProperty_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeHostPoolBackupProperty_UpdateExpanded';
        }
