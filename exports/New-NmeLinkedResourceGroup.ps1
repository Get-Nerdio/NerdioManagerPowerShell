...
param(
    ...
    [NmePowershell.Models.ILinkedResourceGroupCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeLinkedResourceGroup_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeLinkedResourceGroup_NewExpanded';
        }
