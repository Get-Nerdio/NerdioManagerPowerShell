...
<#
.Synopsis
Set scheduled script execution on ARM host pool session hosts' VMs
.Description
Set scheduled script execution on ARM host pool session hosts' VMs

#>
function Set-NmeHostPoolRunScriptSchedule {
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeHostPoolRunScriptSchedule_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeHostPoolRunScriptSchedule_SetExpanded';
        }
