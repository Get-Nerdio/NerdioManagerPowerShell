...
#>
function Set-NmeImageVersionGeoDistribution {
...
param(
    ...
    [NmePowershell.Models.IAppAttachImageVersionUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeImageVersionGeoDistribution_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeImageVersionGeoDistribution_SetExpanded';
        }
