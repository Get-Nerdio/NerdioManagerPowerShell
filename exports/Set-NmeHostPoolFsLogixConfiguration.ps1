...
<#
.Synopsis
Set FSLogix config for ARM host pool
.Description
Set FSLogix config for ARM host pool

#>
function Set-NmeHostPoolFsLogixConfiguration {
[OutputType([NmePowershell.Models.IHostPoolFsLogixConfig])]
...
param(
    ...
    [NmePowershell.Models.IHostPoolFsLogixUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeHostPoolFsLogixConfiguration_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeHostPoolFsLogixConfiguration_SetExpanded';
        }
