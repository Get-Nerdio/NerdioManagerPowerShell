...
#>
function Update-NmeAutoScaleProfile {
...
param(
    ...
    [NmePowershell.Models.IAutoScaleProfileUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeAutoScaleProfile_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeAutoScaleProfile_UpdateExpanded';
        }
