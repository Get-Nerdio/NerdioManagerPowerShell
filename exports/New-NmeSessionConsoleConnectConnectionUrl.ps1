...
#>
function New-NmeSessionConsoleConnectConnectionUrl {
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeSessionConsoleConnectConnectionUrl_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeSessionConsoleConnectConnectionUrl_NewExpanded';
        }
