...
#>
function Update-NmeAppAttachImage {
...
param(
    ...
    [NmePowershell.Models.IAppAttachImageUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeAppAttachImage_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeAppAttachImage_UpdateExpanded';
        }
