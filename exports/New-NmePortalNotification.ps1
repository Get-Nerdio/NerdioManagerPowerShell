...
param(
    ...
    [NmePowershell.Models.IPortalNotificationCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmePortalNotification_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmePortalNotification_NewExpanded';
        }
