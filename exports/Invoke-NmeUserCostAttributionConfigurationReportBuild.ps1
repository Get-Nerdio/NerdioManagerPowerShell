...
#>
function Invoke-NmeUserCostAttributionConfigurationReportBuild {
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeUserCostAttributionConfigurationReportBuild_Invoke';
        }
