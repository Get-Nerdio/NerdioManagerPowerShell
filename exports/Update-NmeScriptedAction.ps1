...
#>
function Update-NmeScriptedAction {
[OutputType([NmePowershell.Models.IResponseWithJobAndScriptedAction])]
...
param(
    ...
    [NmePowershell.Models.IScriptedActionUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeScriptedAction_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeScriptedAction_UpdateExpanded';
        }
