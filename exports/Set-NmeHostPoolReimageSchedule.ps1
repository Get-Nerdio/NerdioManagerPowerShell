...
<#
.Synopsis
Set scheduled re-image ARM host pool session hosts' VMs
.Description
Set scheduled re-image ARM host pool session hosts' VMs

#>
function Set-NmeHostPoolReimageSchedule {
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeHostPoolReimageSchedule_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeHostPoolReimageSchedule_SetExpanded';
        }
