...
<#
.Synopsis
### Notes\n- Only built-in roles are supported now\n- Only workspaces set is supported now
.Description
### Notes\n- Only built-in roles are supported now\n- Only workspaces set is supported now

#>
function Set-NmeRbacAssignment {
...
param(
    ...
    [NmePowershell.Models.IRbacAssignmentUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeRbacAssignment_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeRbacAssignment_SetExpanded';
        }
