...
<#
.Synopsis
New a new recurrent policy
.Description
New a new recurrent policy

#>
function New-NmeAppManagementRecurrentPolicy {
[OutputType([NmePowershell.Models.IResponseWithJobAndAppPolicyRecurrent])]
...
param(
    ...
    [NmePowershell.Models.IAppPolicyRecurrentCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeAppManagementRecurrentPolicy_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeAppManagementRecurrentPolicy_NewExpanded';
        }
