...
#>
function New-NmeAppManagementAppGroup {
...
param(
    ...
    [NmePowershell.Models.IAppGroupCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeAppManagementAppGroup_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeAppManagementAppGroup_NewExpanded';
        }
