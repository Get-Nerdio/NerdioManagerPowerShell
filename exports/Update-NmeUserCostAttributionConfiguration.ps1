...
#>
function Update-NmeUserCostAttributionConfiguration {
...
param(
    ...
    [NmePowershell.Models.IUserCostAttributionConfigurationUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeUserCostAttributionConfiguration_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeUserCostAttributionConfiguration_UpdateExpanded';
        }
