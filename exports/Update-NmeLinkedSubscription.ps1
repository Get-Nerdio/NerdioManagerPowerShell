...
#>
function Update-NmeLinkedSubscription {
...
param(
    ...
    [NmePowershell.Models.ILinkedSubscriptionUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeLinkedSubscription_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeLinkedSubscription_UpdateExpanded';
        }
