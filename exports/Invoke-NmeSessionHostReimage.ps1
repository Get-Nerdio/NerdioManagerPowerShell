...
#>
function Invoke-NmeSessionHostReimage {
...
param(
    ...
    [NmePowershell.Models.IHostReimageRun]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeSessionHostReimage_Invoke';
            InvokeExpanded = 'NerdioManagerPowerShell.private\Invoke-NmeSessionHostReimage_InvokeExpanded';
        }
