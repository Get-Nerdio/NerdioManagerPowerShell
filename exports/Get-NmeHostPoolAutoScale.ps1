...
#>
function Get-NmeHostPoolAutoScale {
[OutputType([NmePowershell.Models.IDynamicPoolConfiguration])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeHostPoolAutoScale_Get';
        }
