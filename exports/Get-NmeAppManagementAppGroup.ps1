...
#>
function Get-NmeAppManagementAppGroup {
[OutputType([NmePowershell.Models.IResponseListAndAppGroup])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeAppManagementAppGroup_Get';
        }
