...
#>
function New-NmeLinkedNetwork {
[OutputType([NmePowershell.Models.ILinkedNetwork])]
...
param(
    ...
    [NmePowershell.Models.ILinkedNetworkCreate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            New = 'NerdioManagerPowerShell.private\New-NmeLinkedNetwork_New';
            NewExpanded = 'NerdioManagerPowerShell.private\New-NmeLinkedNetwork_NewExpanded';
        }
