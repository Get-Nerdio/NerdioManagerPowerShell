...
#>
function Get-NmeImage {
[OutputType([NmePowershell.Models.IVMImage])]
[CmdletBinding(DefaultParameterSetName='Get', PositionalBinding=$false)]
param(
    [Parameter()]
    [NmePowershell.PSArgumentCompleterAttribute("MarketplaceImage", "CustomImage", "ComputeGalleryImage")]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeImage_Get';
        }
