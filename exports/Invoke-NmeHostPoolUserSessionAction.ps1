...
#>
function Invoke-NmeHostPoolUserSessionAction {
...
param(
    ...
    [NmePowershell.Models.IUserSessionAction]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeHostPoolUserSessionAction_Invoke';
            InvokeExpanded = 'NerdioManagerPowerShell.private\Invoke-NmeHostPoolUserSessionAction_InvokeExpanded';
        }
