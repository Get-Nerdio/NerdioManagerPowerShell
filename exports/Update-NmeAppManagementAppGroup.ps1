...
#>
function Update-NmeAppManagementAppGroup {
[OutputType([NmePowershell.Models.IResponseWithJobAndAppGroup])]
...
param(
    ...
    [NmePowershell.Models.IAppGroupUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeAppManagementAppGroup_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeAppManagementAppGroup_UpdateExpanded';
        }
