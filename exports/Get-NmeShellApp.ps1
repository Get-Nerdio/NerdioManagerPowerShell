...
#>
function Get-NmeShellApp {
[OutputType([NmePowershell.Models.IResponseListAndShellApp], [NmePowershell.Models.IShellApp])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeShellApp_Get';
            Get1 = 'NerdioManagerPowerShell.private\Get-NmeShellApp_Get1';
        }
