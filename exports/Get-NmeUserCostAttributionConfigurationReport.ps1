...
#>
function Get-NmeUserCostAttributionConfigurationReport {
[OutputType([NmePowershell.Models.IUserCostAttributionReportResponse])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeUserCostAttributionConfigurationReport_Get';
        }
