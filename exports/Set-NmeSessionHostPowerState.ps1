...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeSessionHostPowerState_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeSessionHostPowerState_SetExpanded';
        }
