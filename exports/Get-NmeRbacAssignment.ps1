...
#>
function Get-NmeRbacAssignment {
[OutputType([NmePowershell.Models.IRbacAssignment])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeRbacAssignment_Get';
            Get1 = 'NerdioManagerPowerShell.private\Get-NmeRbacAssignment_Get1';
        }
