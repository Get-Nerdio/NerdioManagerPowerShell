...
#>
function Invoke-NmeSessionHostAssociateVM {
...
param(
    ...
    [NmePowershell.Models.ISessionHostAssociate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeSessionHostAssociateVM_Invoke';
            InvokeExpanded = 'NerdioManagerPowerShell.private\Invoke-NmeSessionHostAssociateVM_InvokeExpanded';
        }
