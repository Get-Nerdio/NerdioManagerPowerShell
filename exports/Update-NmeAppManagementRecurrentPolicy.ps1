...
#>
function Update-NmeAppManagementRecurrentPolicy {
...
param(
    ...
    [NmePowershell.Models.IAppPolicyRecurrentUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeAppManagementRecurrentPolicy_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeAppManagementRecurrentPolicy_UpdateExpanded';
        }
