...
#>
function Update-NmeHostPoolUsageTrackingProperty {
[OutputType([NmePowershell.Models.IHostPoolTracking])]
...
param(
    ...
    [NmePowershell.Models.IHostPoolTracking]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'NerdioManagerPowerShell.private\Update-NmeHostPoolUsageTrackingProperty_Update';
            UpdateExpanded = 'NerdioManagerPowerShell.private\Update-NmeHostPoolUsageTrackingProperty_UpdateExpanded';
        }
