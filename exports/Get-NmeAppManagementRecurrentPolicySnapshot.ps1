...
#>
function Get-NmeAppManagementRecurrentPolicySnapshot {
[OutputType([NmePowershell.Models.IPolicyState])]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'NerdioManagerPowerShell.private\Get-NmeAppManagementRecurrentPolicySnapshot_Get';
        }
