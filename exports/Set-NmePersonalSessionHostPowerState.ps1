...
#>
function Set-NmePersonalSessionHostPowerState {
...
param(
    ...
    [NmePowershell.Models.IPowerStateCommand]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmePersonalSessionHostPowerState_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmePersonalSessionHostPowerState_SetExpanded';
        }
