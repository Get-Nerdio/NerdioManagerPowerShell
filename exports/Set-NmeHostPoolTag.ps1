...
<#
.Synopsis
Set custom tags for ARM host pool
.Description
Set custom tags for ARM host pool

#>
function Set-NmeHostPoolTag {
[OutputType([NmePowershell.Models.IHostPoolTagsUpdateResult])]
...
param(
    ...
    [NmePowershell.Models.IHostPoolTagsUpdate]
    # .
    ${Body},

    [Parameter(ParameterSetName='SetExpanded', Mandatory)]
    [NmePowershell.Category('Body')]
    [NmePowershell.Runtime.Info(Required, PossibleTypes=([NmePowershell.Models.IHostPoolTagsUpdateTags]))]
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmeHostPoolTag_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmeHostPoolTag_SetExpanded';
        }
