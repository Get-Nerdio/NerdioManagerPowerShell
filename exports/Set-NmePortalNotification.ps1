...
<#
.Synopsis
Set portal notification
.Description
Set portal notification

#>
function Set-NmePortalNotification {
[OutputType([NmePowershell.Models.IResponseWithJobAndPortalNotification])]
...
param(
    ...
    [NmePowershell.Models.IPortalNotificationUpdate]
    # .
    ${Body},
...
begin {
    try {
        ...
        $mapping = @{
            Set = 'NerdioManagerPowerShell.private\Set-NmePortalNotification_Set';
            SetExpanded = 'NerdioManagerPowerShell.private\Set-NmePortalNotification_SetExpanded';
        }
