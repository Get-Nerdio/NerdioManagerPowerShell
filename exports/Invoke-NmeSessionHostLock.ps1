...
#>
function Invoke-NmeSessionHostLock {
[OutputType([NmePowershell.Models.IResourceLockModel])]
...
begin {
    try {
        ...
        $mapping = @{
            Invoke = 'NerdioManagerPowerShell.private\Invoke-NmeSessionHostLock_Invoke';
        }
